...
#define S5K4BA_SNAPSHOT_WIDTH           640
#define S5K4BA_SNAPSHOT_HEIGHT          480
#define S5K4BA_POSTVIEW_WIDTH           640
#define S5K4BA_POSTVIEW_WIDE_WIDTH      640
#define S5K4BA_POSTVIEW_HEIGHT          480
#define S5K4BA_POSTVIEW_BPP             16
#define S5K4BA_THUMBNAIL_WIDTH          160
#define S5K4BA_THUMBNAIL_HEIGHT         120
#define S5K4BA_THUMBNAIL_BPP            16
#define S5K4BA_FOCAL_LENGTH             90
#define S5K4BA_FLAG_HW_UPDOWN_MIRROR	TRUE

#define S5K6AA_PREVIEW_WIDTH            640
#define S5K6AA_PREVIEW_HEIGHT           480
#define S5K6AA_SNAPSHOT_WIDTH           640
#define S5K6AA_SNAPSHOT_HEIGHT          480
#define S5K6AA_POSTVIEW_WIDTH           640
#define S5K6AA_POSTVIEW_WIDE_WIDTH      640
#define S5K6AA_POSTVIEW_HEIGHT          480
#define S5K6AA_POSTVIEW_BPP             16
#define S5K6AA_THUMBNAIL_WIDTH          160
...
#define BACK_CAMERA_FLAG_HW_UPDOWN_MIRROR	JOIN(BACK_CAM,_FLAG_HW_UPDOWN_MIRROR)
...
public:
    ...
    int             setVerticalMirror(int cam_fd);
    int             setHorizontalMirror(int cam_fd);
